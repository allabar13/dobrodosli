...
const UNITS = [
  {
    id:'u1', emoji:'👋', title:'Здраво!', sub:'Поздороваться и не спалиться',
    lessons: [
      { id:'u1l1', title:'Первые слова', words:['zdravo','cao','dobar_dan','hvala','molim','da','ne'],
  ...
  {
    id:'u2', emoji:'☕', title:'Кафана', sub:'Главный институт страны',
    lessons: [
  ...
  {
    id:'u3', emoji:'💰', title:'Бројеви и паре', sub:'Числа, цены, пияца',
    lessons: [
  ...
  {
    id:'u4', emoji:'🏙️', title:'Град', sub:'Город и навигация',
    lessons: [
  ...
  {
    id:'u5', emoji:'📋', title:'Папири', sub:'Бюрократия: спецкурс эмигранта',
    lessons: [
  ...
  {
    id:'u6', emoji:'🏠', title:'Стан', sub:'Квартира, газда, комшије',
    lessons: [
  ...
  {
    id:'u7', emoji:'🌊', title:'Polako-вайб', sub:'Слова-пароли и смолток',
    lessons: [
  ...
  {
    id:'u8', emoji:'🛠️', title:'Глаголы выживания', sub:'Сказать, понять, заплатить',
    lessons: [
